...
struct BuildScriptPackagingTests {
    ...
    func globalReleaseDocumentsBothMacArchitectures() throws {
        ...
        #expect(readme.contains("CodexQ-1.0.21-arm64.zip"))
        #expect(readme.contains("CodexQ-1.0.21-x86_64.zip"))
        ...
        #expect(englishReadme.contains("CodexQ-1.0.21-arm64.zip"))
        #expect(englishReadme.contains("CodexQ-1.0.21-x86_64.zip"))
