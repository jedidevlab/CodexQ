...
struct BuildScriptPackagingTests {
    ...
    func globalReleaseDocumentsBothMacArchitectures() throws {
        ...
        #expect(readme.contains("CodexQ-1.1.2-arm64.zip"))
        #expect(readme.contains("CodexQ-1.1.2-x86_64.zip"))
        ...
        #expect(englishReadme.contains("CodexQ-1.1.2-arm64.zip"))
        #expect(englishReadme.contains("CodexQ-1.1.2-x86_64.zip"))
