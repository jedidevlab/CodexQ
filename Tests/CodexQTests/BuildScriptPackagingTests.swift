...
struct BuildScriptPackagingTests {
    ...
    func globalReleaseDocumentsBothMacArchitectures() throws {
        ...
        #expect(readme.contains("CodexQ-1.1.0-arm64.zip"))
        #expect(readme.contains("CodexQ-1.1.0-x86_64.zip"))
        ...
        #expect(englishReadme.contains("CodexQ-1.1.0-arm64.zip"))
        #expect(englishReadme.contains("CodexQ-1.1.0-x86_64.zip"))
