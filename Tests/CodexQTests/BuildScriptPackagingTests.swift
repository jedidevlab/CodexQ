...
struct BuildScriptPackagingTests {
    ...
    func globalReleaseDocumentsBothMacArchitectures() throws {
        ...
        #expect(readme.contains("CodexQ-1.0.12-arm64.zip"))
        #expect(readme.contains("CodexQ-1.0.12-x86_64.zip"))
        ...
        #expect(englishReadme.contains("CodexQ-1.0.12-arm64.zip"))
        #expect(englishReadme.contains("CodexQ-1.0.12-x86_64.zip"))
