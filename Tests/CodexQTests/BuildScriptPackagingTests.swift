...
struct BuildScriptPackagingTests {
    ...
    func globalReleaseDocumentsBothMacArchitectures() throws {
        ...
        #expect(readme.contains("CodexQ-1.1.1-arm64.zip"))
        #expect(readme.contains("CodexQ-1.1.1-x86_64.zip"))
        ...
        #expect(englishReadme.contains("CodexQ-1.1.1-arm64.zip"))
        #expect(englishReadme.contains("CodexQ-1.1.1-x86_64.zip"))
