...
struct BuildScriptPackagingTests {
    ...
    func globalReleaseDocumentsBothMacArchitectures() throws {
        ...
        #expect(readme.contains("CodexQ-1.1.3-arm64.zip"))
        #expect(readme.contains("CodexQ-1.1.3-x86_64.zip"))
        ...
        #expect(englishReadme.contains("CodexQ-1.1.3-arm64.zip"))
        #expect(englishReadme.contains("CodexQ-1.1.3-x86_64.zip"))
