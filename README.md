...
| Mac | 安装包 |
| --- | --- |
| Apple Silicon | `CodexQ-1.0.20-arm64.zip` |
| Intel | `CodexQ-1.0.20-x86_64.zip` |
...
```bash
./script/package_release.sh 1.0.20 arm64
./script/package_release.sh 1.0.20 x86_64
```

生成文件位于：

```text
dist/CodexQ-1.0.20-arm64.zip
dist/CodexQ-1.0.20-x86_64.zip
```
